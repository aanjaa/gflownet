...
class RNABinding():
    ...
    def __init__(
        ...
        self.cost = 0
        self.name = f"RNABinding_T{targets}_L{seq_length}"
    ...
    def get_fitness(self, sequences) -> np.ndarray:
        """
...
class RNABindingTask(GFNTask):
    ...
    def __init__(
        ...
        self.task_name = task
        problem = registry()[self.task_name]
        self.task = RNABinding(**problem['params'])
