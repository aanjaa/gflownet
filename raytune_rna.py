...
def exploration_config(exploration_strategy):
    if exploration_strategy == "e_random_action":
        ...
        return {
            ...
            "cond.temperature.dist_params": [4, 64], 
            "cond.temperature.num_thermometer_dim": 50,
        }
    else:
...
if __name__ == "__main__":
    ...
    num_training_steps = 8000 #1000 # 15_650 #10_000
    validate_every = 500  #100 # 1000 #1000
    ...
    config = {
        ...
        "cond": {
            "temperature": {
                ...
                "dist_params": [24.0],  # [0, 64.0],  #[16,32,64,96,128]
                "num_thermometer_dim": 1,
                "val_temp": 24.0,
            }
        },
        "task": {"name": "rna_bind", "helper": "seh_frag", "tdc": {"oracle": "qed"}},
        "evaluation": {
            "k": 100,
            "reward_thresh": 0.8,
            "distance_thresh": 0.3,
